...
CREATE TABLE controla (
    id INT auto_increment PRIMARY KEY,
    id_dueno VARCHAR(9) NOT NULL,  -- ahora referencia a usuario con rol Administrador
    id_mascota INT NOT NULL,
    FOREIGN KEY (id_dueno) REFERENCES usuario(id),
    FOREIGN KEY (id_mascota) REFERENCES mascota(id)
);
...
CREATE TABLE atiende (
    id INT auto_increment PRIMARY KEY,
    id_dueno VARCHAR(9) NOT NULL, -- ahora referencia a usuario con rol Veterinario
    id_mascota INT NOT NULL,
    FOREIGN KEY (id_dueno) REFERENCES usuario(id),
    FOREIGN KEY (id_mascota) REFERENCES mascota(id)
);
...
INSERT INTO mascota (nombre, especie, edad, sexo, peso, vacunas, historial, id_dueno)
VALUES ("Dante", "Perro Labrador", "2 años", "Macho", 40.0, true, "Ojo vago.", NULL),
...
VALUES ("12345678A","Ana Lucía", "Barrios Plana", "123456789", "230200@iessierradeguara.com", "ana", "Administrador"),
       ("23456789B","Julian David", "Reyes Casas", "987654321", "230140@iessierradeguara.com", "julian", "Administrador");

-- INSERCIÓN DE USUARIOS VETERINARIOS --
INSERT INTO usuario (id, nombre, apellidos, telefono, correo, usuario, rol)
VALUES ('34567890C', 'Lucía', 'García Pérez', '612345678', 'lucia.garcia@email.com', 'luciagarcia', 'Veterinario'),
       ('45678901D', 'Carlos', 'Martínez López', '698765432', 'carlos.martinez@email.com', 'carlosmartinez', 'Veterinario'),
       ('56789012E', 'Ana', 'Sánchez Ruiz', '654321987', 'ana.sanchez@email.com', 'anasanchez', 'Veterinario'),
       ('67890123F', 'Miguel', 'Fernández Díaz', '623498765', 'miguel.fernandez@email.com', 'miguelfernandez', 'Veterinario'),
       ('78901234G', 'Elena', 'Torres Gómez', '687123459', 'elena.torres@email.com', 'elenatorres', 'Veterinario');
